...
2.  **[0. Kiến trúc Tổng quan](./0.%20Kiến%20trúc%20Tổng%20quan.md)**
...
|---|--------|----------------|
| **1** | **[Hệ thống Lưu trữ (IPFS)](./1.%20IPFS.md)** | Content Addressing, CID, Pinning, Cách VinaLib lưu ảnh bìa sách. |
| **2** | **[Smart Contracts - Cơ bản](./2.%20Smart%20Contracts%20(Cơ%20bản).md)** | Solidity, EVM, Gas, Workflow chính của BookAsset & BookRental. |
| **3** | **[Smart Contracts - Nâng cao](./3.%20Smart%20Contracts%20(Nâng%20cao).md)** | Layer 2 Scaling, Design Patterns (Ownable), Token Standards (ERC-721, SBT). |
| **4** | **[Chainlink Oracle](./4.%20Chainlink.md)** | Kết nối dữ liệu off-chain, VRF (Randomness), Automation, Functions. |
| **5** | **[IoT & Thực tế](./5.%20IoT.md)** | Kết nối khóa thông minh, MQTT, Bảo mật thiết bị vật lý. |
...
> **Lưu ý:** Các đường dẫn trong tài liệu được thiết kế tương thích với GitHub Viewer.
=======
# 📘 Bộ Tài liệu Khái niệm VinaLib - Web3 & Blockchain
